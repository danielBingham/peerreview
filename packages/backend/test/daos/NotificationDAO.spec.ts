...
import { Notification, getNotificationFixture, ResultType, DatabaseResult } from '@danielbingham/peerreview-model'
...
describe('NotificationDAO', function() {
    ...
    describe('hydrateNotification()', function() {
        it('should properly hydrate a single Notification based on a single QueryResultRow', async function() {
            ...
            const fixture = getNotificationFixture(ResultType.Database) as DatabaseResult<Notification>
    ...
    describe('hydrateNotifications()', function() {
        it('should properly interpret a QueryResultRow[] and return DatabaseResult<Notification>', async function() {
            const journalSubmissionDAO = new NotificationDAO(mockCore)
