...
import { JournalSubmission, getJournalSubmissionFixture, ResultType, DatabaseResult } from '@danielbingham/peerreview-model'
...
describe('JournalSubmissionDAO', function() {
    ...
    describe('hydrateJournalSubmission()', function() {
        it('should properly hydrate a single JournalSubmission based on a single QueryResultRow', async function() {
            ...
            const fixture = getJournalSubmissionFixture(ResultType.Database) as DatabaseResult<JournalSubmission>
    ...
    describe('hydrateJournalSubmissions()', function() {
        it('should properly interpret a QueryResultRow[] and return DatabaseResult<JournalSubmission>', async function() {
            const journalSubmissionDAO = new JournalSubmissionDAO(mockCore)
