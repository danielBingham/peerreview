...
import { Permission, DatabaseQuery, DatabaseResult, ModelDictionary } from '@danielbingham/peerreview-model'
...
export class PermissionDAO {
    ...
    hydratePermissions(rows: QueryResultRow[]): DatabaseResult<Permission> {
