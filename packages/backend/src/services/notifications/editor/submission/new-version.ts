...
export const Editor_Submission_NewVersion: NotificationDefinition = {
    email: {
        subject: Handlebars.compile(
            `[JournalHub] {{correspondingAuthor.name}} uploaded a new version of your editorial assignment, "{{paper.title}}"`),
