...
export function getJournalSubmissionFixture(resultType: ResultType, filter?: (element: any, index: any, array: any[]) => boolean) {
    return generateFixture<JournalSubmission>(journalSubmissions, resultType, filter)
}
